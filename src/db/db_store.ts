...
import { User, Lomba, Prestasi, Beasiswa, BeasiswaTimeline, Webinar, Certification, SystemSettings } from '../types';
...
export function convertGoogleDriveUrl(url: string | undefined): string {
  ...
  // Pattern 4: https://docs.google.com/file/d/FILE_ID/edit
  let fileId = '';
  ...
  if (fileId) {
    // Return direct webcontent render URL
  ...
  users: [
    {
      ...
      angkatan: '2023',
      role: 'user',
      passwordHash: '230000', // Last 6 digits of NIM: "3333230000" -> "230000"
...
export function getDatabase(): DatabaseSchema {
  try {
    if (fs.existsSync(DB_FILE_PATH)) {
      ...
      // Auto convert Google Drive links on load so client doesn't need to do it or backend serves formatted urls
      if (parsed.lombas) {
